...
#' @examples # none
#' @export
xtable2 <- function(tab, aln = NULL, pad = 0,  digits = 2, caption = NULL, label = NULL, size = "footnotesize", footNotes = NULL, include.rownames = TRUE, formatColNames = TRUE, statsLine = TRUE, specialChars = c("#"), ...){
	# if numeric, shoudl round to something
	# tab <- prmat; pad = 0; digits = 2; aln = NULL; include.rownames = FALSE; formatColNames = TRUE; statsLine = TRUE
	size <- paste0("\\", size)
